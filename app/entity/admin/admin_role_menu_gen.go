...
func (orm *OrmAdminRoleMenu) TableName() string {
	return "admin_role_menu"
}

func NewOrmAdminRoleMenu(txs ...*gorm.DB) *OrmAdminRoleMenu {
	var tx *gorm.DB
	if len(txs) == 0 {
		tx = providers.GetBean("mysql, admin").(*gorm.DB).Model(&AdminRoleMenu{})
	} else {
		tx = txs[0].Model(&AdminRoleMenu{})
	}
	return &OrmAdminRoleMenu{db: tx}
}
...
func (orm *OrmAdminRoleMenu) GetTableInfo() interface{} {
...
// Exists 检索对象是否存在
func (orm *OrmAdminRoleMenu) Exists() (bool, error) {
	dest := &struct {
		H int `json:"h"`
	}{}
...
func (orm *OrmAdminRoleMenu) Unscoped() *OrmAdminRoleMenu {
	orm.db.Unscoped()
	return orm
}
...
func (orm *OrmAdminRoleMenu) Group(name string) *OrmAdminRoleMenu {
	orm.db.Group(name)
	return orm
}
...
func (orm *OrmAdminRoleMenu) Select(query interface{}, args ...interface{}) *OrmAdminRoleMenu {
	orm.db.Select(query, args...)
	return orm
}

func (orm *OrmAdminRoleMenu) Sum(field string) int64 {
	type result struct {
		S int64 `json:"s"`
	}
	ret := result{}
...
func (orm *OrmAdminRoleMenu) Preload(query string, args ...interface{}) *OrmAdminRoleMenu {
...
func (orm *OrmAdminRoleMenu) Joins(query string, args ...interface{}) *OrmAdminRoleMenu {
