...
type ApiDemoHomeRequest struct {
	...
	// @Tag("bson")
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" bson:"id" form:"id" gorm:"autoUpdateTime:nano"`
}
...
type ApiDemoHomeResponse struct {
	...
	StartTime string `protobuf:"bytes,1,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty" form:"start_time" gorm:"autoUpdateTime:nano"`
	Tip       string `protobuf:"bytes,2,opt,name=tip,proto3" json:"tip,omitempty" form:"tip" gorm:"autoUpdateTime:nano"`
	// Types that are assignable to Data:
	//
	//	*ApiDemoHomeResponse_Name
	Data isApiDemoHomeResponse_Data `protobuf_oneof:"data" form:"data" gorm:"autoUpdateTime:nano"`
}
...
type ApiDemoHomeResponse_Name struct {
	Name string `protobuf:"bytes,3,opt,name=name,proto3,oneof" form:"name" gorm:"autoUpdateTime:nano"`
}
...
var file_api_demo_proto_rawDesc = []byte{
	...
	0x2f, 0x61, 0x70, 0x69, 0x2f, 0x64, 0x65, 0x6d, 0x6f, 0x1a, 0x07, 0xc2, 0xf3, 0x18, 0x03, 0x61,
...
func file_api_demo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_demo_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_demo_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	file_api_demo_proto_msgTypes[1].OneofWrappers = []any{
